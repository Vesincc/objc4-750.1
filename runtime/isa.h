...
#   define ISA_BITFIELD                                                                     \
      ...
      uintptr_t has_assoc         : 1;  /*是否有关联引用，没有关联引用可以更快释放*/                \
      uintptr_t has_cxx_dtor      : 1;  /*是否含有析构函数*/                                   \
      uintptr_t shiftcls          : 33; /*MACH_VM_MAX_ADDRESS 0x1000000000 isa指向的地址*/    \
      uintptr_t magic             : 6;  /*是否初始化完成*/                                     \
      uintptr_t weakly_referenced : 1;  /*是否被弱引用*/                                      \
      uintptr_t deallocating      : 1;  /*是否释放中*/                                        \
      uintptr_t has_sidetable_rc  : 1;  /*是否引用计数太大越界*/ \
